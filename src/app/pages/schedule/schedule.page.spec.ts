...
describe('SchedulePage', () => {
  ...
  // El Punto D necesita una selección previa del Punto C; si no la encuentra
  // redirige a /service-selection en ngOnInit. Se siembra localStorage para
  // que el componente se monte con normalidad durante el test.
  beforeEach(() => {
    ...
    // El componente navega con router.navigateByUrl; en el test no hay rutas
    // reales, así que se intercepta para observar el destino sin navegar.
    navigateSpy = vi
  ...
  it('confirmar cita añade un registro a vb_appointments', () => {
    ...
    // Tras confirmar se navega al Punto E.
